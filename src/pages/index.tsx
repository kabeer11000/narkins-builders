    ...
    <>
      ...
      <div>
        ...
        <header className="relative flex items-center justify-center min-h-[70vh] overflow-hidden">
          ...
          <video ref={videoRef} preload='yes' poster='/videoframe_0.png' style={{zIndex: -99}} className="max-h-screen absolute w-auto min-w-full min-h-full filter brightness-50 max-w-none"
